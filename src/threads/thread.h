...
#include <stdint.h>
//Edit: Include files
/* Adding 2 additional header files. These files containing new function/variable
definitions, needed for requrired functionalities */
#include "synch.h"
...
struct thread
  {
    ...
    //Edit: Add variable, Priority scheduling
    ...
    //Edit: Adding variable/structure
    //Edit: Prioirity scheduling
...
//Edit: Add functions
/* These lines below are prototypes of additional functions defined in thread.c */
//Edit: Priority scheduling
